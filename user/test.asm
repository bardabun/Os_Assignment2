...
main(int argc, char *argv[])
{
  ...
  14:	29a080e7          	jalr	666(ra) # 2aa <fork>
    }
    int pid = getpid();
  18:	00000097          	auipc	ra,0x0
  1c:	31a080e7          	jalr	794(ra) # 332 <getpid>
  20:	85aa                	mv	a1,a0
    printf("-> %d\n", pid);
  22:	00000517          	auipc	a0,0x0
  26:	7ae50513          	addi	a0,a0,1966 # 7d0 <malloc+0xe8>
  2a:	00000097          	auipc	ra,0x0
  2e:	600080e7          	jalr	1536(ra) # 62a <printf>
    exit(0);
  32:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39a:	44a50513          	addi	a0,a0,1098 # 7e0 <digits>
 39e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 466:	37eb8b93          	addi	s7,s7,894 # 7e0 <digits>
 ...
 5a6:	23690913          	addi	s2,s2,566 # 7d8 <malloc+0xf0>
        while(*s != 0){
...
free(void *ap)
{
 ...
 66e:	18e7b783          	ld	a5,398(a5) # 7f8 <freep>
 ...
 69c:	00e6ea63          	bltu	a3,a4,6b0 <free+0x50>
{
 ...
 6de:	10f73f23          	sd	a5,286(a4) # 7f8 <freep>
}
 6e2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 710:	0ec53503          	ld	a0,236(a0) # 7f8 <freep>
 ...
 738:	0c490913          	addi	s2,s2,196 # 7f8 <freep>
  if(p == (char*)-1)
 73c:	5afd                	li	s5,-1
 73e:	a88d                	j	7b0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 740:	00000797          	auipc	a5,0x0
 744:	0c078793          	addi	a5,a5,192 # 800 <base>
 748:	00000717          	auipc	a4,0x0
 74c:	0af73823          	sd	a5,176(a4) # 7f8 <freep>
 750:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 772:	08a73523          	sd	a0,138(a4) # 7f8 <freep>
      return (void*)(p + 1);
